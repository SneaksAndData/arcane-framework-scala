...
trait StagedBatch:
   ...
   * @param actualSchema Schema of the table that holds batch data generated by applying all batches in chain.
   * @return SQL query text
   */
  def archiveExpr(actualSchema: ArcaneSchema): String
