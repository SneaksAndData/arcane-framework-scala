...
import com.sneaksanddata.arcane.framework.services.consumers.{ArchiveableBatch, MergeableBatch, StagedBatch, StagedVersionedBatch}
...
trait RowGroupTransformer:
  ...
  type ToInFlightBatch = (Iterable[StagedVersionedBatch & MergeableBatch & ArchiveableBatch], Long, Chunk[Any]) => OutgoingElement
