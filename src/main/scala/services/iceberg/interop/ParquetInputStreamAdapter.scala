...
/**
 * Wrapper class for org.apache.iceberg.io.SeekableInputStream that maps it to org.apache.parquet.io.DelegatingSeekableInputStream
 *
 * @param stream Iceberg SeekableInputStream from file.newStream()
 */
