...
object TestTableMaintenanceSettings extends TableMaintenanceSettings:
  ...
  override val targetSnapshotExpirationSettings: Option[SnapshotExpirationSettings] = Some(TestSnapshotExpirationSettings)
  override val targetOrphanFilesExpirationSettings: Option[OrphanFilesExpirationSettings] = Some(TestOrphanFilesExpirationSettings)
